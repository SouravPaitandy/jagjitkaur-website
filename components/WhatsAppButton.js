export default function WhatsAppButton({ productName, product }) {
  ...
  return (
    <a
      ...
      className=" bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-green-600/25 hover:shadow-xl hover:shadow-green-700/30 transform hover:scale-105"
    >
