      ...
      <main className="relative min-h-screen bg-stone-50 dark:bg-stone-900">
        ...
        <div className="relative bg-stone-50 dark:bg-stone-900 py-16 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            {/* Enhanced Title with Royal Design */}
            <div className="mb-8">
            ...
            {/* Enhanced Statistics with Royal Touch */}
          ...
          {(filterBy !== "all" || searchQuery) && (
            <div className="mb-8 flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="text-sm text-stone-600 dark:text-stone-400 hover:text-stone-800 dark:hover:text-stone-200 font-medium transition-colors"
              >
                Clear all
              </button>
            </div>
