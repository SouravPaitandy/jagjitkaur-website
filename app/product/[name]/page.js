          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-stone-800 p-6 rounded-md shadow-lg border border-stone-200 dark:border-stone-700 animate-fade-in-up">
                  <div className="flex items-center space-x-4 mb-4">
                    <span className="text-4xl font-bold text-stone-900 dark:text-stone-100 font-fira-sans">
                      {product.price}
                    </span>
                    {product.originalPrice && (
                      <>
                        <span className="text-xl text-stone-500 dark:text-stone-400 line-through opacity-75 hover:opacity-100 transition-opacity duration-300">
                          {product.originalPrice}
                        </span>
                        <span className="bg-stone-800 dark:bg-stone-100 text-stone-200 dark:text-stone-800 px-3 py-1 rounded-md text-sm font-bold">
                          SAVE{" "}
                          {Math.round(
                            ((parseInt(
                  ...
                  <div className="flex items-center space-x-1 mb-4 group">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        key={i}
                        className="w-5 h-5 text-amber-600 dark:text-amber-400 fill-current transform group-hover:scale-110 transition-transform duration-200"
                    ...
                    <span className="text-stone-600 dark:text-stone-300 ml-2 font-medium opacity-80 hover:opacity-100 transition-opacity duration-300">
                      5.0 (24+ reviews)
                    </span>
                  </div>

                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="p-3 bg-stone-50 dark:bg-stone-700 rounded-md transform hover:scale-105 hover:shadow-md transition-all duration-300 hover:bg-stone-100 dark:hover:bg-stone-600">
                      <div className="text-2xl font-bold text-stone-900 dark:text-white animate-fade-in">
                        100%
                      </div>
                    ...
                    <div
                      className="p-3 bg-stone-50 dark:bg-stone-700 rounded-md transform hover:scale-105 hover:shadow-md transition-all duration-300 hover:bg-stone-100 dark:hover:bg-stone-600"
              ...
              <div className="bg-stone-100 dark:bg-stone-800 p-6 rounded-md border border-stone-200 dark:border-stone-700">
                ...
                <p className="text-stone-600 dark:text-stone-300 leading-relaxed italic border-l-4 border-stone-300 dark:border-stone-600 pl-4">
                  "Each thread tells a story of heritage, each motif carries the
                  legacy of generations of master craftsmen. This isn't just
                  clothing - it's wearable art that celebrates the timeless
                ...
                <div className="bg-white dark:bg-stone-800 p-6 rounded-md shadow-lg border border-stone-200 dark:border-stone-700">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { label: "Craft Work", value: product.work, icon: "✨" },
